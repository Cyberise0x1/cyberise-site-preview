export default function WhyUs() {
  const reasons = [
    { num: "01", title: "Elite Expertise", desc: "Our team consists of certified offensive security professionals, ex-intelligence operators, and master developers." },
    { num: "02", title: "Global Reach", desc: "Based in Nigeria, delivering to 45+ countries. We understand global standards and local operational challenges." },
    { num: "03", title: "Zero Trust Security", desc: "Every application we build and system we deploy is architected with a military-grade zero-trust framework." },
    { num: "04", title: "Rapid Delivery", desc: "In the digital frontier, speed is survival. We deploy complex systems and execute operations faster than the industry average." }
  ];

  return (
    <section id="why-us" className="bg-[rgba(18,18,26,0.3)] border-y border-[rgba(0,240,255,0.05)]">
