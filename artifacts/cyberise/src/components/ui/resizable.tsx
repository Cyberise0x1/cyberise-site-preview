...
// react-resizable-panels v4 renamed primitives:
//   PanelGroup -> Group, PanelResizeHandle -> Separator, prop `direction` -> `orientation`.
// The Group root carries `data-orientation` and the Separator `aria-orientation`,
// which we key the vertical-layout styles off of.
