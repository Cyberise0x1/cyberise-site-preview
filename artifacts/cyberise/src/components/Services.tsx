import { Globe, Smartphone, Building2, Shield, Target, Crosshair, ArrowRight } from "lucide-react";
    ...
    <section id="services">
      <div className="text-center mb-[80px] reveal">
        ...
        <p className="text-[1.1rem] text-[#a0a0b8] max-w-[600px] mx-auto leading-[1.7]">
          From concept to deployment, we deliver end-to-end digital solutions that transform businesses and secure nations.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-[30px] max-w-[1400px] mx-auto">
        {services.map((s, i) => {
          ...
          let iconBg = "bg-[rgba(0,240,255,0.08)] border-[rgba(0,240,255,0.15)] text-[#00f0ff]";
          let shadowClass = "hover:shadow-[0_30px_60px_rgba(0,0,0,0.3),0_0_30px_rgba(0,240,255,0.3)]";
          
          if (s.color === "secondary") {
            gradientClass = "bg-[linear-gradient(135deg,#7b2ff7,#ff2d55)]";
            iconBg = "bg-[rgba(123,47,247,0.08)] border-[rgba(123,47,247,0.15)] text-[#7b2ff7]";
            shadowClass = "hover:shadow-[0_30px_60px_rgba(0,0,0,0.3),0_0_30px_rgba(123,47,247,0.3)]";
          } else if (s.color === "accent") {
            gradientClass = "bg-[linear-gradient(135deg,#ff2d55,#00f0ff)]";
            iconBg = "bg-[rgba(255,45,85,0.08)] border-[rgba(255,45,85,0.15)] text-[#ff2d55]";
            shadowClass = "hover:shadow-[0_30px_60px_rgba(0,0,0,0.3),0_0_30px_rgba(255,45,85,0.3)]";
          }
          ...
          return (
            <div key={i} className={cn(
              ...
              <a href="#contact" className="inline-flex items-center gap-[8px] mt-[20px] text-[#00f0ff] no-underline font-rajdhani font-semibold tracking-[1px] uppercase text-[0.9rem] transition-all duration-300 hover:gap-[15px] group/link">
